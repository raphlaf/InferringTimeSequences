...
file_path = "Code/Fig 2/data.jld2"
...
FI_values = zeros(4, res)

FI_values[1, :] = fisher.(T, arange, cdef, taudef, betadef, x0)
FI_values[2, :] = fisher.(T, adef, crange, taudef, betadef, x0)
FI_values[3, :] = fisher.(T, adef, cdef, taurange, betadef, x0)
FI_values[4, :] = fisher.(T, adef, cdef, taudef, betarange, x0)
