...
file_path = "Code/Fig 6/data_abs.jld2"
...
opt_relative = false  # optimize relative CRLB
save_relative = opt_relative  # save relative CRLB values
if (opt_relative) file_path = "Code/Fig 6/data_rel.jld2" end
