...
data = h5py.File("Fig 3/data1.jld2")
data2 = h5py.File("Fig 3/data2.jld2")
...
cbar_ax.set_yticklabels([r"$\leq 0.27$", r"$\geq 0.37$"])
...
cbar_ax.set_yticklabels([r"$\leq 0.26$", r"$\geq 0.33$"])
cbar_ax.tick_params(axis="y", which="both", length=0, pad=1.2)
cbar_ax.set_ylabel("CRLB $(s)$")
...
cbar_ax.set_yticklabels([r"$\leq 0.21$", r"$\geq 0.27$"])
cbar_ax.tick_params(axis="y", which="both", length=0, pad=1.2)
